...
async function main() {
	...
	const cryptoContextBuffer =
		module.SerializeCryptoContextToBuffer(cryptoContext,module.SerType.JSON);
	...
	const cc = module.DeserializeCryptoContextFromBuffer(
		cryptoContextBuffer, module.SerType.JSON);
	...
	const publicKeyBuffer =
		module.SerializePublicKeyToBuffer(keyPair.publicKey,module.SerType.JSON);
	console.log("The public key has been serialized");

	// Serialize the private key
	const privateKeyBuffer =
		module.SerializePrivateKeyToBuffer(keyPair.secretKey,module.SerType.JSON);
	...
	const evalMultKeyBuffer =
		cc.SerializeEvalMultKeyToBuffer(module.SerType.JSON);
	...
	const automorphismKeyBuffer =
		cc.SerializeEvalAutomorphismKeyToBuffer(module.SerType.JSON);
	...
	const pk = module.
		DeserializePublicKeyFromBuffer(publicKeyBuffer,module.SerType.JSON);
	...
	const ciphertext1Buffer =
		module.SerializeCiphertextToBuffer(ciphertext1, module.SerType.JSON);
	console.log("The first ciphertext has been serialized.");

	const ct1 =
		module.DeserializeCiphertextFromBuffer(ciphertext1Buffer,module.SerType.JSON);
	...
	cc.DeserializeEvalMultKeyFromBuffer(evalMultKeyBuffer,module.SerType.JSON);
	console.log("Deserialized the eval mult keys");

	cc.DeserializeEvalAutomorphismKeyFromBuffer(
		automorphismKeyBuffer,module.SerType.JSON);
	...
	const sk = module.DeserializePrivateKeyFromBuffer(
		privateKeyBuffer, module.SerType.JSON);

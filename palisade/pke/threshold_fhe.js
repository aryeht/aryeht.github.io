// follows RunCKKS() from ./examples/cpp/pke/threshold-fhe-js.cpp
async function main() {
	...
	const cc = module.GenCryptoContextCKKS(
		init_size - 1, dcrtBits, batchSize,
		module.SecurityLevel.HEStd_128_classic,
		0, // ringDimension
		module.RescalingTechnique.APPROXRESCALE,
		module.KeySwitchTechnique.BV,
		2, // numLargeDigits
		2, // maxDepth
		60, // firstMod
		5, module.MODE.OPTIMIZED);
